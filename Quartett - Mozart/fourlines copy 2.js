...
function draw() {
    ...
    if (Math.max(dataPoints1[currentDataPointIndex1 - 1].xPos, dataPoints2[currentDataPointIndex2 - 1].xPos, dataPoints3[currentDataPointIndex3 - 1].xPos, dataPoints4[currentDataPointIndex4 - 1].xPos) - xOffset > canvasWidth) {
...
function drawLine1() {
    ...
    stroke(0, 255, 0); // Green color for Violoncello
    strokeWeight(2);
    noFill();
    beginShape();
    ...
    drawDots(dataPoints1.slice(1, currentDataPointIndex1));
}
...
function drawLine2() {
    ...
    stroke(255, 0, 0); // Red color for Viola
    strokeWeight(2);
    noFill();
    beginShape();
    ...
    // Draw dots for each data point
    drawDots(dataPoints2.slice(1, currentDataPointIndex2));
}
...
function drawLine3() {
    ...
    stroke(0); // Black color for Violin
    strokeWeight(2);
    noFill();
    beginShape();
    ...
    // Draw dots for each data point
    drawDots(dataPoints3.slice(1, currentDataPointIndex3));
}
...
function drawLine4() {
    ...
    stroke(0, 0, 255); // Blue color for Violin 2
    strokeWeight(2);
    noFill();
    beginShape();
    ...
    // Draw dots for each data point
    drawDots(dataPoints4.slice(1, currentDataPointIndex4));
}

function drawDots(dataPoints) {
    fill(0); // Set dot color (black)
    noStroke();
